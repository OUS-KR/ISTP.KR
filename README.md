...
- `ISTP.KR/u/{사용자 아이디}/{글 경로}` 형태의 글 작성
  - 마크다운 문법: [마크다운 문법](https://github.com/OUS-KR/ISTP.KR?tab=readme-ov-file#%EB%A7%88%ED%81%AC%EB%8B%A4%EC%9A%B4-%EB%AC%B8%EB%B2%95-%EC%98%88%EC%8B%9C), [마크다운 문법 예제](https://istp.kr/@istp/articles/md_example)
...
- 유튜브 채널 RSS: `ISTP.KR/yt/rss/{유튜브 채널 아이디}`
  - 예제: [ISTP.KR/yt/rss/UC-Fnix71vRP64WXeo0ikd0Q](https://istp.kr/yt/rss/UC-Fnix71vRP64WXeo0ikd0Q)
...
[마크다운 문법 예제](https://istp.kr/@istp/articles/md_example)
